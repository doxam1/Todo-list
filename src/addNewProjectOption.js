...
function renderProjectsArray() {
  ...
  projectsArray.forEach((project) => {
    ...
    newProjectOption.textContent = project.split('_').join(' ');
    ...
    projectNavBtn.textContent = `${project.split('_').join(' ')}`;
    ...
    delBtnForProject.onclick = () => {
      ...
      document.querySelector(".confirmDeletebtn").onclick = (e) => {
        ...
        const todoDivSameAsProject = document.querySelectorAll(
          `.todoDiv.${project}`
        );
      ...
      document.querySelector(".cancelDeleteProject").onclick = () =>
        document.querySelector(".confirmDeleteProject").close();
    };
...
projectName.addEventListener("change", (e) => {
  if (e.target.value == "newProject") {
    ...
    projectsArray.push(newProjectName.split(" ").join("_"));
